                            ...
                            HStack{
                                ...
                                Section{
                                    VStack{
                                        ...
                                        HStack{
                                            //Scooter Location
                                            Text(scooter.location).underline()
                                            ...
                                            VStack{
                                                ...
                                                Text(scooter.ScooterID.suffix(3)).underline()
                                            }
                                            ...
                                            Section{
                                                VStack{
                                                    Text("Availability").font(.caption).underline()
                                                    ...
                                                    Text("Battery").font(.caption).underline()
                                                    HStack{
                                                        Text(  scooter.battery.suffix(3)).font(.caption)
                                                        Text("%")
                                                    }
                                                }
                                            ...
                                            //Charger items
                                            VStack{
                                                Text("Charger").font(.caption).underline()
                                                ...
                                                else if scooter.nearestCharger == "Orange" {
